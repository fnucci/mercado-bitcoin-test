...
public class AtivoExceptionHandler {

    @ExceptionHandler(AtivoNotFoundException.class)
    public ResponseEntity<ApiErrorArray> handleAtivoNotFound(AtivoNotFoundException ex, HttpServletRequest request) {
        return buildErrorResponse(HttpStatus.NOT_FOUND, ex, request);
    }

    @ExceptionHandler({
            AtivoUpdateNotPermitException.class,
            InvalidAtivoException.class
    })
